...
**Status:** ARCHIVED — Core Ollama management implemented (install, pull, health, auto-start, keep-alive, wizard). Rich UI features (model library, deletion, VRAM diagnostics, pull progress bar) deferred to post-release.
**Created:** 2026-03-11  
**Priority:** High  

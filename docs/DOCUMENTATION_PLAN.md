...
### C. Migration (`docs/migration/`)
*   **`v1-to-v2-guide.md`**: Key differences for upgraders coming from the V1 Electron app.
...
| | DOC-7.3 | Draft `migration/v1-to-v2-guide.md`. | ⏳ Pending |

...
*   **Audio Ducking**: An advanced feature that automatically lowers the volume of other applications (like Spotify, YouTube, or video games) whenever you start dictating. When the recording finishes, your volume is instantly restored.
    ...
    *   **Fade Duration**: Instead of jarringly cutting your background music, dIKta.me can smoothly ramp down the volume when you start speaking and smoothly ramp it back up when you finish. You can customize the exact duration of this crossfade transition for a seamless audio experience.
*   **Mute Detection**: dIKta.me intelligently detects if your microphone is hardware-muted. If you attempt to dictate while muted, the app will instantly alert you, preventing wasted dictation breath.

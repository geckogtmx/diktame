...
public sealed record PipelineResult
{
    ...
    /// <summary>Number of input tokens consumed by the LLM, if reported.</summary>
    public int? InputTokens { get; init; }

    /// <summary>Number of output tokens generated by the LLM, if reported.</summary>
    public int? OutputTokens { get; init; }

    /// <summary>Duration of the source audio in seconds (from STT provider).</summary>

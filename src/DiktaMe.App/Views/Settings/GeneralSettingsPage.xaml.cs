...
/// <summary>
/// General settings page — hosts Application, Control Panel, Keyboard Shortcuts, and Language sub-items.
/// The hotkey recording logic is code-behind key capture (moved from HardwareSettingsPage).
/// </summary>

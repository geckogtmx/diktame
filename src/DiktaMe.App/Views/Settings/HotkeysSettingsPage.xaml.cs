...
{
    public HotkeysSettingsViewModel ViewModel { get; }
    ...
    {
        ViewModel = App.Current.Services.GetRequiredService<HotkeysSettingsViewModel>();
    ...
    private void StartRecording(TextBox textBox, string target)
    {
        ...
        // Focus and attach handler
        textBox.Focus(FocusState.Programmatic);
        textBox.KeyDown += TextBox_KeyDown;
        textBox.LostFocus += TextBox_LostFocus;

        ViewModel.SetRecordingTarget(target);
    }
    ...
    private void StopRecording()
    {
        ...
        ViewModel.SetRecordingTarget(null);
    }
    ...
    private void TextBox_KeyDown(object sender, KeyRoutedEventArgs e)
    {
        ...
        // Update ViewModel
        ViewModel.SetHotkeyValue(_recordingTarget, hotkeyString);
